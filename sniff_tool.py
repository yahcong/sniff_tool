...
def main(args):
    ...
    if args.pcap:
        ...
        if args.filterip:
            ...
            print 'vnfm_port:'+str(vnfm_port)
            print 'nfvo_port:'+str(nfvo_port)
            print 'vnf_port:'+str(vnf_port)
            print 'openstack_port:'+str(openstack_port)
            print 'sniff:'
            sniff(iface=conf.iface, prn=pkt_parser, store=0)
            #save as pcap style package
            #dpkt = sniff(iface=conf.iface, prn=pkt_parser, store=1)
